...
# -*- coding: utf-8 -*-
"""Main Module.
This python module is the main module of the movie trailer website.
It contains all the movies and their relevant information. A user can
add more movies just by adding a newinstance containing the movie name,
storyline, poster, and youtube url to the array of (MOVIES).
"""
import media
...
DOCTOR_STRANGE = media.Movie('Doctor Strange', "Dr. Stephen Strange's (Benedict Cumberbatch)\
  ...
  When traditional medicine fails him, he looks for healing,\
  and hope, in a mysterious enclave. He quickly learns that the\
  enclave is at the front line of a battle against unseen dark forces bent\
  on destroying reality. Before long, Strange is forced to choose between his\
